...
## Overview of the configuration of the Maggot tool
...
Terminology is the set of terms used to define the metadata of a dataset. A single file (***web/conf/config_terms.txt***) contains all the terminology. It is therefore necessary to create and fill it, according to the following scheme:
